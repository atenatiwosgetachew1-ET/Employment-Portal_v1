...
urlpatterns = [
    ...
    path("employees/ocr/status/", EmployeeOcrStatusView.as_view(), name="employees-ocr-status"),
    path("employees/ocr/", EmployeeOcrExtractView.as_view(), name="employees-ocr"),
    ...
    path("employees/<int:employee_pk>/process/decline/", EmployeeProcessDeclineView.as_view(), name="employees-process-decline"),
